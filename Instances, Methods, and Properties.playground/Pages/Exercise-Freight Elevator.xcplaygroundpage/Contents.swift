 ...
 */
let itemWeightLow = 25
let itemWeightMed = 100
let itemWeightHig = 1250
/*:
 - callout(Exercise): 
...
var ricketyRopeTwo = TreehousePulley(weightCapacity: 2000)
/*:
 - callout(Exercise): 
 ...
 */
ricketyRope.addLoadToBasket(loadWeight: itemWeightLow * 3 + itemWeightMed)
ricketyRope.canHandleAdditionalLoad(itemWeightMed)
ricketyRopeTwo.addLoadToBasket(loadWeight: itemWeightMed + itemWeightHig)
/*:
